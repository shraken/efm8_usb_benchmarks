...
#define RXBUF_XDATA
	...
	typedef BYTE __xdata Ttxbuffer;
	...
	typedef BYTE __xdata Trxbuffer;
...
extern volatile __bit uart_DTR;				// Line status output
extern volatile __bit uart_RTS;
extern volatile TLine_Coding __idata uart_line_coding;
...
extern __bit TXReady;							// TX buffer has data to transmit
extern __bit RXReady;							// RX buffer has room
