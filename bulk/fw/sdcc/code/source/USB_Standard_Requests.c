...
extern Tdevice_descriptor __code DeviceDesc;
extern Tconfiguration_desc_set __code ConfigDescSet;
extern BYTE __code * __code StringDescTable[];
...
__code BYTE ONES_PACKET[2] = {0x01, 0x00};		
__code BYTE ZERO_PACKET[2] = {0x00, 0x00};		
